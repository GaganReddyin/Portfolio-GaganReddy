export const Bio = {
  ...
  resume:
    "https://drive.google.com/file/d/1t8DeiWNL2_59o1FpH4Pw4AI_afw_hbdE/view?usp=sharing",
...
export const experiences = [
  {
    ...
    desc: "I managed event budgets, tracked expenses, and optimized revenue streams.",
    skills: [
      "Finance Analysis",
      "Problem Solving",
      "Business Analysis",
  ...
  {
    id: 0,
    role: "Human Resource Senior Associate",
    company: "The Entrepreneurship Network",
    date: "March 2022 - Nov 2022",
    desc: "I managed recruitment processes, conducted interviews, and facilitated on boarding.",
    skills: [
      "Recruiting",
      "HR Strategy",
      "HR Operations",
  ...
  },
  {
    ...
    desc: "Conducted thorough market research to identify potential clients, market trends and competitors.",
    skills: [
      "Strategic Planning",
      "Business Analysis",
      "Analytical Skills",
...
export const education = [
  {
    ...
    grade: "7.69* CGPA",
    degree: "Integrated MTech - Software Engineering",
  },
  {
    id: 1,
    school: "Sri Chaitanya Junior Colllege, Tirupati",
  ...
  {
    id: 2,
    school: "Spring Dale Public School, Tirupati",
